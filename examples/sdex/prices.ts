...
console.log(
  StellarPrice.describe({ price: ratio, baseAsset: demo, quoteAsset: xlm }),
);
console.log("Exact inverse:", StellarPrice.format(StellarPrice.invert(ratio)));
console.log("2/3 compared with 1.25:", StellarPrice.compare(ratio, decimal));
