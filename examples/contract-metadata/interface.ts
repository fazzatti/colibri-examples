/**
 * Example: Structural Interface Analysis
 *
 * Compare the functions in a local Wasm specification with Colibri's bundled
 * SEP-41 definition. Inspect missing, incompatible and additional functions
 * independently of metadata claims.
 *
 * Run: deno task interface
 */
import {
...
/**
 * Interface analysis is independent of metadata claims. A contract could
 * omit a claim and still match an ABI, or claim a SEP and expose an
 * incompatible ABI.
 */
...
/**
 * Extract the ABI describing callable functions and their types. The next
 * comparison checks this structure against an installed standard definition,
 * rather than trusting a separate author claim.
 */
