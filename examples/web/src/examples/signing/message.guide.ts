...
export default {
  ...
  "steps": [
    "Create a practice identity. This lesson has its own provider and unfunded key held only in memory. The header wallet remains unchanged, and leaving the lesson destroys the key.",
